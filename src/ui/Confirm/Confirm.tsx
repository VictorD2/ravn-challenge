...
const Confirm: FC<ConfirmProps> = (props) => {
  ...
  let styleColorButton = {
    ...
    danger: "bg-red-800 hover:bg-secondary",
    primary: "bg-primary",
  };
  ...
  let iconType = {
    ...
    primary: (
      <Icon remixicon="" font={{ size: "text-2xl", color: "text-primary" }} />
    ),
  };
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-[400] inset-0 overflow-y-auto"
        onClose={setOpen}
      >
        <Container
        ...
        >
          ...
          <Transition.Child
            ...
            leave="ease-in duration-200"
          >
            <div className="inline-block px-10 py-5 align-bottom bg-primary rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <Container
                bgColor="bg-primary"
              ...
              >
                <Container display="sm:flex" align="sm:items-start">
                  ...
                  >
                    <Dialog.Title
                      as="h3"
                      className="text-2xl lg:text-start md:text-start text-center leading-6 font-medium text-white"
                    >
                      {title}
                    </Dialog.Title>
